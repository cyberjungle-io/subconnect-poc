...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      {editMode ? (
        <Button className="flex items-center justify-center bg-transparent text-red-500 hover:text-white py-2 px-4 transition duration-150 ease-in-out" onClick={handleToggleEditMode}>Cancel</Button>
      ) : (
...
>
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 pe-1">
