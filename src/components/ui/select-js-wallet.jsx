...
const PolkadotJSModal = ({onClose,handleSelectContent }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 z-40 flex justify-center items-center" onClick={onClose}>
      <div onClick={handleModalClick} className="relative bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-lg w-full max-w-lg max-h-full overflow-y-auto z-50 scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-transparent scrollbar-thumb-rounded-scroll">
        <button
          onClick={onClose}
