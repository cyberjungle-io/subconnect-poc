        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            ...
            <div className="flex space-x-4 mt-2 hover:text-gray-400">
              ...
              <a href="https://twitter.com/Subconnect_io" target="_blank" rel="noopener noreferrer" className="fill-white hover:fill-gray-400 "><svg width="25" height="25" viewBox="0 0 1200 1227" fill="white" xmlns="http://www.w3.org/2000/svg">
